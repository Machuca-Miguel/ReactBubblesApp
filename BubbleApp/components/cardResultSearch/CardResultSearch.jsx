...
export const CardResultSearch = ({searchList,resetSearch}) => {
  return (
            ...
            <div className=" d-flex flex-column">
              ...
              <ListGroup className="list-group-flush">
                <ListGroup.Item className="py-0">
                  <span className="fs-6 fw-bolder">Size:</span>
                  {elem.size}
                </ListGroup.Item>
                <ListGroup.Item className="py-0">
                  <span className="fs-6 fw-bolder">Weight:</span>
                  {elem.weight}
                </ListGroup.Item>
                <ListGroup.Item className="py-0">
                  <span className="fs-6 fw-bolder">Diet:</span>
                  {elem.diet}
                </ListGroup.Item>
                <ListGroup.Item className="py-0">
                  <span className="fs-6 fw-bolder">Habitat:</span>
                  {elem.habitat}
                </ListGroup.Item>
              ...
              <Card.Body className="py-0 d-flex justify-content-between pb-3 gap-2">
                <Card.Text className="mb-0 ">
                  <span className="fs-6 fw-bolder">Fun fact:</span>
                  {elem.funFact}
                </Card.Text>
